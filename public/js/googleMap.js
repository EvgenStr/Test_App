...
(function () {
    ...
    google.maps.Load = function (apiLoad) {
        ...
        apiLoad([0.009999999776482582, [null, [['https://khms0.googleapis.com/kh?v=804&hl=ru&', 'https://khms1.googleapis.com/kh?v=804&hl=ru&'], null, null, null, 1, "804", ['https://khms0.google.com/kh?v=804&hl=ru&', 'https://khms1.google.com/kh?v=804&hl=ru&']], null, null, null, null, [["https://cbks0.googleapis.com/cbk?", "https://cbks1.googleapis.com/cbk?"]], [['https://khms0.googleapis.com/kh?v=118&hl=ru&', 'https://khms1.googleapis.com/kh?v=118&hl=ru&'], null, null, null, null, "118", ['https://khms0.google.com/kh?v=118&hl=ru&', 'https://khms1.google.com/kh?v=118&hl=ru&']], [['https://mts0.googleapis.com/mapslt?hl=ru&', 'https://mts1.googleapis.com/mapslt?hl=ru&']], null, null, null, [['https://mts0.googleapis.com/mapslt?hl=ru&', 'https://mts1.googleapis.com/mapslt?hl=ru&']]], ["ru", "US", null, 0, null, null, "https://maps.gstatic.com/mapfiles/", "https://csi.gstatic.com", "https://maps.googleapis.com", "https://maps.googleapis.com", null, "https://maps.google.com", "https://gg.google.com", "https://maps.gstatic.com/maps-api-v3/api/images/", "https://www.google.com/maps", 0, "https://www.google.com"], ["https://maps.googleapis.com/maps-api-v3/api/js/34/3/intl/ru_ALL", "3.34.3"], [1059630220], 1, null, null, null, null, null, "", null, null, 1, 'https://khms.googleapis.com/mz?v=804&', null, "https://earthbuilder.googleapis.com", "https://earthbuilder.googleapis.com", null, "https://mts.googleapis.com/maps/vt/icon", [["https://maps.googleapis.com/maps/vt"], ["https://maps.googleapis.com/maps/vt"], null, null, null, null, null, null, null, null, null, null, ["https://www.google.com/maps/vt"], "/maps/vt", 432000000, 432], 2, 500, [null, null, null, null, "https://www.google.com/maps/preview/log204", "", "https://static.panoramio.com.storage.googleapis.com/photos/", ["https://geo0.ggpht.com/cbk", "https://geo1.ggpht.com/cbk", "https://geo2.ggpht.com/cbk", "https://geo3.ggpht.com/cbk"], "https://maps.googleapis.com/maps/api/js/GeoPhotoService.GetMetadata", "https://maps.googleapis.com/maps/api/js/GeoPhotoService.SingleImageSearch", ["https://lh3.ggpht.com/", "https://lh4.ggpht.com/", "https://lh5.ggpht.com/", "https://lh6.ggpht.com/"]], null, null, null, null, "/maps/api/js/ApplicationService.GetEntityDetails", 0, null, null, null, null, [], ["34.3"], 1, 0, [1]], loadScriptTime);
    };
    var loadScriptTime = new Date().getTime();
})();
// inlined
(function (_) {
    var _ta, xa, za, Ba, Ca, Da, Sa, Ta, fb, kb, lb, ob, tb, sb, ub, vb, Mb, Ob, Sb, $b, bc, cc, oc, qc, xc, Hc, Ic, Jc, Kc, Mc, Nc, _Qc, Tc, Pc, Xc, cd, ld, od, qd, yd, Ad, zd, Id, Md, Od, Qd, Ud, Rd, Wd, Zd, _ce, de, Vd, Yd, be, ee, ie, je, ke, Be, Ce, De, Ge, He, Je, Ke, Oe, Pe, Qe, Re, Ue, We, Xe, hf, jf, kf, of, qf, rf, Cf, Df, Ef, Jf, Kf, Mf, Nf, Of, Uf, Vf, Xf, Zf, bg, cg, ig, gg, jg, kg, mg, pg, rg, qg, tg, xg, zg, Dg, Eg, Fg, Ig, Jg, Kg, Lg, Mg, wa, va, Ha, Ga, Pa, Qa;
    _.aa = "ERROR";
    ...
    Ca = function Ca(a, b, c) {
        ...
        for (var d = a.length, e = 0; e < d; e++) {
            var f = a[e];
            if (b.call(c, f, e, a)) return { oe: e, Gi: f };
        }
        return { oe: -1, Gi: void 0 };
    };
    Da = function Da(a, b) {
    ...
    sb = function sb() {
        ...
        "undefined" === typeof a && "undefined" !== typeof window && window.postMessage && window.addEventListener && !_.cb("Presto") && (a = function a() {
    ...
    _.Rb = function (a, b) {
        ...
        return function (d) {
            ...
            var e = {},
                f;
            for (f in d) {
                if (e[f] = d[f], !b && !a[f]) throw _.Pb(c + "unknown property " + f);
            }for (f in a) {
                try {
                    var g = a[f](e[f]);
    ...
    _.zc = function (a, b) {
        ...
        } else this.f = new xc(1, -1), this.b = new qc(180, -180);
    };
    ...
    _.Cc = function (a) {
        ...
        try {
            return a = Bc(a), _.Ac(a.south, a.west, a.north, a.east);
        } catch (b) {
    ...
    _.xd = function (a) {
        ...
        if (!b) {
            ...
            for (var d; d = td.exec(a);) {
                d = d[0], b[c++] = td.lastIndex - d.length, b[c++] = (0, window.parseInt)(d, 10);
            }b[c] = a.length;
        }
        this.f = b;
        this.Ob = this.f[0];
    ...
    Ad = function Ad(a, b, c) {
        ...
        d.forEach(function (b) {
            var e = b.Cc,
                g = a[e + d.Ob];
            if (null != g) if (b.Sd) for (var h = 0; h < g.length; ++h) {
                zd(g[h], e, b, c);
            } else zd(g, e, b, c);
        });
    };
    ...
    _.Ld = function () {
        for (var a = Array(36), b = 0, c, d = 0; 36 > d; d++) {
            8 == d || 13 == d || 18 == d || 23 == d ? a[d] = "-" : 14 == d ? a[d] = "4" : (2 >= b && (b = 33554432 + 16777216 * Math.random() | 0), c = b & 15, b >>= 4, a[d] = Kd[19 == d ? c & 3 | 8 : c]);
    ...
    _ce = function ce(a, b) {
        a.m[b] || (a.m[b] = !0, be(a.j, function (c) {
    ...
    _.S = function (a, b, c) {
        var d = Wd.b();
        a = "" + a;
        d.b[a] ? b(d.b[a]) : ((d.f[a] = d.f[a] || []).push(b), c || _ce(d, a));
    };
    _.fe = function (a, b) {
        Wd.b().b["" + a] = b;
    };
    ...
    _.Ie = function (a) {
        this.__gm = { set: null, pe: null, ic: { map: null, Pe: null } };
        He.call(this, a);
    };
    Je = function Je(a, b) {
        this.b = a;
        this.f = b;
        a.addListener("map_changed", (0, _.y)(this.Ul, this));
        this.bindTo("map", a);
    ...
    _.yf = function (a, b) {
        ...
        if (90 == c || -90 == d || 1E-6 > e) return new _.zc(new _.L(d, -180), new _.L(c, 180));
    ...
    Cf = function Cf(a, b) {
        ...
        b && b.Ie && (a = b.Ie, _.F(a.zoom) || (a.zoom = _.Fa(b.zoom) ? b.zoom : 1));
        this.setValues(b);
    ...
    Ef = function Ef(a, b, c, d) {
        ...
        this.B = new Cf(c, { visible: !1, enableCloseButton: !0, lb: e });
    ...
    Uf = function Uf(a) {
        if (!Pf) {
            var b = Pf = { C: "meummm" };
            if (!Qf) {
                var c = Qf = { C: "ebb5ss8MmbbbEIb100b" };
                Rf || (Rf = { C: "eedmbddemd", F: ["uuuu", "uuuu"] });
                c.F = [Rf, "Eb"];
            }
            c = Qf;
            Sf || (Sf = { C: "10m12m", F: ["bb", "b"] });
            b.F = ["ii", "uue", c, Sf];
        }
    ...
    Zf = function Zf(a, b) {
        ...
        c.onerror = null;
        var d = a.ef();
        d && (b && (c.parentNode || a.b.appendChild(c), a.j || _.Gf(c, d)), a.set("loading", !1));
    };
    bg = function bg(a, b, c, d, e) {
        ...
        h.data[11] = !0;
        _.Bf[13] && (b = new Jf(_.Gd(h, 7)), b.data[0] = 33, b.data[1] = 3, b.data[7] = 1);
        f = a.G + (0, window.unescape)("%3F") + Uf(f);
        return a.D(f);
    };
    cg = function cg(a, b) {
        var c = a.f;
        b != c.src ? (a.j || _.Yf(c), c.onload = function () {
            Zf(a, !0);
        }, c.onerror = function () {
            Zf(a, !1);
    ...
    ig = function ig(a, b) {
        ...
        f = _.Hf(d);
        var g = null;
        gg(c.useStaticMap, f) && (g = new Vf(d, _.hg, _.Q(_.uf(_.T), 9)), g.set("size", f), g.bindTo("center", this), g.bindTo("zoom", this), g.bindTo("mapTypeId", this), g.bindTo("styles", this));
    ...
    pg = function pg(a) {
        return a instanceof _.dd ? og(a) : new _.dd((0, _.ne)(a));
    };
    rg = function rg(a) {
        if (_.La(a) || a instanceof _.dd) {
            if (0 == _.E(a)) var b = !0;else b = a instanceof _.dd ? a.getAt(0) : a[0], b = _.La(b) || b instanceof _.dd;
        } else b = !1;
    ...
    _.Og = function (a) {
        ...
        if (!(a instanceof _.L || a instanceof _.zc || a instanceof _.sg)) try {
            a = _.Cc(a);
        } catch (b) {
            try {
                a = _.pc(a);
    ...
    Ba("Promise", function (a) {
        ...
        b.prototype.l = function () {
            ...
            var b = this,
                c = !1;
            return { resolve: a(this.I), reject: a(this.m) };
        };
        b.prototype.I = function (a) {
            if (a === this) this.m(new TypeError("A Promise cannot resolve to itself"));else if (a instanceof b) this.aa(a);else {
                a: switch (typeof a === 'undefined' ? 'undefined' : _typeof(a)) {
                    case "object":
                        var c = null != a;
                        break a;
                    case "function":
        ...
        b.all = function (a) {
            ...
            return e.done ? d([]) : new b(function (a, b) {
                ...
                var g = [],
                    h = 0;
                do {
                    g.push(void 0), h++, d(e.value).ae(f(g.length - 1), b), e = c.next();
                } while (!e.done);
            });
        };
        return b;
    ...
    var Pg;
    if ("function" == typeof Object.setPrototypeOf) Pg = Object.setPrototypeOf;else {
        var Qg;
        a: {
            var Rg = { Uj: !0 },
                Tg = {};
    ...
    Ba("Map", function (a) {
        ...
        function d(a, b) {
            var c = b && (typeof b === 'undefined' ? 'undefined' : _typeof(b));
        ...
        e.prototype["delete"] = function (a) {
            a = d(this, a);
            return a.Xa && a.list ? (a.list.splice(a.index, 1), a.list.length || delete this.f[a.id], a.Xa.Rb.next = a.Xa.next, a.Xa.next.Rb = a.Xa.Rb, a.Xa.head = null, this.size--, !0) : !1;
        };
    ...
    a: {
        ...
        if (_.Zg) {
            var mh = kb();
            if (null != mh && mh > (0, window.parseFloat)(kh)) {
                jh = String(mh);
                break a;
            }
        }
    ...
    _.nh = jh;
    var ph = _.w.document;
    _.oh = ph && _.Zg ? kb() || ("CSS1Compat" == ph.compatMode ? (0, window.parseInt)(_.nh, 10) : 5) : void 0;
    _.qh = _.cb("Firefox");
    _.rh = _.ib() || _.cb("iPod");
    _.sh = _.cb("iPad");
    _.th = _.hb();
    ...
    _.Bh = { ROADMAP: "roadmap", SATELLITE: "satellite", HYBRID: "hybrid", TERRAIN: "terrain" };
    _.Af = {
        TOP_LEFT: 1,
        TOP_CENTER: 2,
        TOP: 2,
    ...
    _.Kh = new _.fc({ Kc: new _.ec(256), Lc: void 0 });
    ...
    var Bc = _.Rb({ south: _.ac, west: _.ac, north: _.ac, east: _.ac }, !1);
    var Lc;
    _.M = {
        addListener: function addListener(a, b, c) {
            return new Mc(a, b, c, 0);
        }, hasListeners: function hasListeners(a, b) {
            if (!a) return !1;
            b = (a = a.__e3_) && a[b];
            return !!b && !_.db(b);
        }, removeListener: function removeListener(a) {
            a && a.remove();
        }, clearListeners: function clearListeners(a, b) {
            _.yb(Ic(a, b), function (a, b) {
                b && b.remove();
            });
        }, clearInstanceListeners: function clearInstanceListeners(a) {
        ...
        }, addListenerOnce: function addListenerOnce(a, b, c) {
            var d = _.M.addListener(a, b, function () {
                d.remove();
                return c.apply(this, arguments);
            });
            return d;
        }, forward: function forward(a, b, c) {
    ...
    _.m.set = function (a, b) {
        ...
        var d = Mb(c, a);
        if (d) {
            if (a = d.Db, d = d.fd, c = "set" + _.Sc(a), d[c]) d[c](b);else d.set(a, b);
        } else this[a] = b, c[a] = null, _Qc(this, a);
    };
    _.m.notify = function (a) {
        var b = Tc(this);
        a += "";
        (b = Mb(b, a)) ? b.fd.notify(b.Db) : _Qc(this, a);
    };
    ...
    _.N.prototype.unbind = function (a) {
        var b = Tc(this),
            c = b[a];
        c && (c.Xg && delete Pc(c.fd, c.Db)[_.Oc(c.Xg)], this[a] = this.get(a), b[a] = null);
    };
    ...
    var Mh = _.Rb({ zoom: _.G(Ch), heading: Ch, pitch: Ch });
    _.A(_.kd, _.Yc);
    _.kd.prototype.set = function (a) {
        this.m && this.get() === a || (this.ni(a), this.notify());
    };
    _.A(ld, _.kd);
    ...
    _.xd.prototype.forEach = function (a, b) {
        for (var c = {
            ...
            c.Cc++;
            g == e && (c.Cc = this.f[f++], e = this.f[f++], g += Math.ceil(Math.log10(c.Cc + 1)));
            var k = this.b.charCodeAt(g++),
                n = k & -33,
                p = c.type = Nh[n];
            c.value = b && b[c.Cc + this.Ob];
            b && null == c.value || (c.Sd = k == n, k = n - 75, c.Nh = 0 <= n && 0 < (4321 & 1 << k), a(c));
    ...
    Id.prototype.set = function (a, b) {
        if (null != b && !(b && _.F(b.maxZoom) && b.tileSize && b.tileSize.width && b.tileSize.height && b.getTile && b.getTile.apply)) throw Error('\u041E\u0436\u0438\u0434\u0430\u0435\u043C\u043E\u0435 \u0437\u043D\u0430\u0447\u0435\u043D\u0438\u0435 \u0434\u043B\u044F \u0440\u0435\u0430\u043B\u0438\u0437\u0430\u0446\u0438\u0438: google.maps.MapType');
    ...
    */
    ...
    var Ph = { Rn: "Point", Nn: "LineString", POLYGON: "Polygon" };
    var Qh = {
        CIRCLE: 0,
    ...
    var Xh = _.Rb({ routes: _.Vb(_.Wb(_.Gb)) }, !0);
    var Xd = {
        main: [],
        common: ["main"],
        util: ["common"],
    ...
    _.yb(Yh.modules, $h);
    delete Yh.modules;
    var ai = _.Rb({ source: _.Dh, webUrl: _.Gh, iosDeepLinkId: _.Gh });
    var bi = _.Zb(_.Rb({ placeId: _.Gh, query: _.Gh, location: _.pc }), function (a) {
    ...
    _.bd(He.prototype, {
        ...
        label: _.G(_.Yb([_.Dh, {
            Cg: $b("text"),
            then: _.Rb({ text: _.Dh, fontSize: _.Gh, fontWeight: _.Gh, fontFamily: _.Gh }, !0)
        }])),
        shadow: _.mb,
        shape: _.mb,
        cursor: _.Gh,
    ...
    _.Ie.MAX_ZINDEX = 1E6;
    _.bd(_.Ie.prototype, { map: _.Yb([_.Rh, ci]) });
    _.A(Je, _.N);
    _.m = Je.prototype;
    ...
    _.bd(Oe.prototype, { directions: Xh, map: _.Rh, panel: _.G(_.Wb(Sb)), routeIndex: _.Fh });
    ...
    _.bd(_.Te.prototype, { map: _.Rh, url: null, bounds: null, opacity: _.Fh });
    _.fi = {
        UNKNOWN: "UNKNOWN",
        OK: _.ha,
    ...
    _.A(_.Ve, _.N);
    _.bd(_.Ve.prototype, { map: _.Rh });
    _.A(We, _.N);
    _.bd(We.prototype, { map: _.Rh });
    _.A(Xe, _.N);
    _.bd(Xe.prototype, { map: _.Rh });
    _.Ze.prototype.re = !0;
    ...
    var fg = "StopIteration" in _.w ? _.w.StopIteration : { message: "StopIteration", stack: "" };
    ...
    jf.prototype.next = function () {
        if (this.j) {
            if (!this.node || this.l && 0 == this.depth) throw fg;
            var a = this.node;
            var b = this.b ? -1 : 1;
            if (this.f == b) {
    ...
    _.zf = { japan_prequake: 20, japan_postquake2010: 24 };
    _.li = { NEAREST: "nearest", BEST: "best" };
    _.mi = { DEFAULT: "default", OUTDOOR: "outdoor" };
    _.A(Cf, _.nd);
    ...
    Cf.prototype.registerPanoProvider = function (a, b) {
        this.set("panoProvider", { di: a, options: b || {} });
    };
    ...
    _.A(Vf, _.Ff);
    var Wf = { roadmap: 0, satellite: 2, hybrid: 3, terrain: 4 },
        ri = { 0: 1, 2: 2, 3: 2, 4: 2 };
    _.m = Vf.prototype;
    _.m.xh = _.$c("center");
    _.m.Mg = _.$c("zoom");
    ...
    _.m.changed = function () {
        var a = this.xh(),
            ...
            c = Xf(this),
            d = !!this.ef();
        if (a && !a.ba(this.ma) || this.da != b || this.Ka != c || this.m != d) this.j || _.Yf(this.f), this.S(), this.da = b, this.Ka = c, this.m = d;
        this.ma = a;
    };
    _.m.pa = function () {
        var a = Xf(this);
        if (this.j && this.A) this.l != a && _.Yf(this.f);else {
            var b = "",
                c = this.xh(),
                d = this.Mg(),
                e = this.ef();
            if (e) {
                if (c && (0, window.isFinite)(c.lat()) && (0, window.isFinite)(c.lng()) && 1 < d && null != a && e && e.width && e.height && this.b) {
                    ...
                    c && (this.A = !0, this.l = a, this.j && this.f && (b = _.hc(d, 0, 0), this.j.set({
                        image: this.f, Fa: {
                            min: _.ic(b, { W: c.N, Y: c.P }), max: _.ic(b, { W: c.T, Y: c.U })
                        }, size: { width: e.width, height: e.height }
                    })), b = bg(this, c, d, a, f));
                }
                this.f && (_.Gf(this.f, e), cg(this, b));
            }
        }
    };
    ...
    _.bd(kg.prototype, { map: _.Rh, tableId: _.Fh, query: _.G(_.Yb([_.Dh, _.Wb(_.Gb, "not an Object")])) });
    _.A(_.lg, _.N);
    ...
    _.bd(_.lg.prototype, { panes: null, projection: null, map: _.Yb([_.Rh, ci]) });
    ...
    _.bd(_.sg.prototype, { center: _.G(_.pc), draggable: _.Hh, editable: _.Hh, map: _.Rh, radius: _.Fh, visible: _.Hh });
    _.A(tg, _.N);
    ...
    _.bd(tg.prototype, { draggable: _.Hh, editable: _.Hh, map: _.Rh, visible: _.Hh });
    _.A(_.ug, tg);
    _.ug.prototype.Ya = !0;
    ...
    _.bd(_.wg.prototype, { draggable: _.Hh, editable: _.Hh, bounds: _.G(_.Cc), map: _.Rh, visible: _.Hh });
    _.A(xg, _.N);
    ...
    _.bd(_.Ag.prototype, { opacity: _.Fh });
    _.A(_.Bg, _.N);
    ...
    _.A(_.Cg, _.Bg);
    _.A(Dg, _.N);
    _.bd(Dg.prototype, { attribution: _.qa(!0), place: _.qa(!0) });
    var si = {
        Animation: { BOUNCE: 1, DROP: 2, Tn: 3, On: 4 },
        Circle: _.sg,
        ...
        MapTypeRegistry: Id,
        Marker: _.Ie,
        MarkerImage: function MarkerImage(a, b, c, d, e) {
            this.url = a;
            this.size = b || e;
            this.origin = c;
            this.anchor = d;
        ...
        NavigationControlStyle: {
            DEFAULT: 0, SMALL: 1,
            ANDROID: 2, ZOOM_PAN: 3, Un: 4, Kj: 5
        },
        OverlayView: _.lg,
        Point: _.H,
        Polygon: _.ug,
